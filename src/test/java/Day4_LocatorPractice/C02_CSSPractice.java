...
public class C02_CSSPractice {
   ...
   @Before
    public void setup() {
       //Driver ile ilgili her turlu initial(baslangic) islemi burada yapılır
   ...
   @After
    public void tearDown() {
       //test sonrasinda driver kapatmak (varsa raporlari dosyalamak) için kullanilir.
       driver.quit();
   }
    @Test
        public void cssSelectorTest() {
           ...
           createElements(100);
           //deleteButtonAndValidate metodu ile 40 buton silinir ve kontrol edilir
    ...
    public void createElements(int amount) {
        ...
        public void deleteButtonsAndValidate(int amount){
            ...
            int silinmedenOnceDeleteButtonSayisi = deleteButtonList.size();//100
            ...
            driver.findElements(By.cssSelector("button{onclick='deleteElement()']"));
            int silinmedenSonraDeleteButtonSayisi = deleteButtonsListAfter.size();//60

            //İlk sayi ile son yasi arasındaki farki dogrularız
